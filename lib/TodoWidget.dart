...
class TodoWidget extends StatefulWidget {
  ...
  late NotificationWeekAndTime dateAffiche = new NotificationWeekAndTime(
      date: DateTime.now(), timeOfDay: TimeOfDay.now());
  List _allResults = [];
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  children: <Widget>[
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (pickedSchedule != null) {
                                          createReminderNotification(
                                              pickedSchedule, nomTodo);
                                          setState(() {
                                            dateAffiche = pickedSchedule;
                                            dateTodo = new DateTime(
                                                pickedSchedule.date.year,
                                                pickedSchedule.date.month,
                                                pickedSchedule.date.day,
                                    ...
                                    Text("${dateAffiche.date.toLocal()}".split(
                                        ' ')[0]),
                                    Text("${dateAffiche.timeOfDay.hour}".split(
                                        ' ')[0] + "h" +
                                        "${dateAffiche.timeOfDay.minute}".split(
                                            ' ')[0]),
